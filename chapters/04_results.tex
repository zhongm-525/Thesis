...
% TODO: workspace plots, occlusion statistics, DS2 time-series confirmation.

\section{PCC Analytical Baseline (Exp 1)}

\subsection{Single-Segment PCC on DS2 (Exp 1A)}
% TODO: error distribution, failure modes.

\subsection{Two-Segment PCC on DS1 (Exp 1B, if attempted)}
% TODO: note whether the stretch goal was pursued.

\section{MLP IK (Exp 2)}

\subsection{Tip-Only MLP (Exp 2A)}
% TODO: results on DS1 and DS2.

\subsection{Tip + Mid Ablation on DS1 (Exp 2B)}
...
% TODO: sim-only baseline vs. fine-tuned on real DS2.
